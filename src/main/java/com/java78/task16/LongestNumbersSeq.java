...
public class LongestNumbersSeq {
    public static void main(String[] args) {
        ...
        int dim = sc.nextInt();
        System.out.println("Intoduceti " + dim + "numere intregi: ");
        ...
        for (int i = 0; i <dim ; i++) {
            while (true) {
                try {
                    ...
                    // e reprezinta instanta clasei de exceptie InputMismatchException, adica un obiect
                    System.out.println("Input invalid, introduceti doar valori intregi");
                    sc.next(); // curata inputul invalid ramas in urma afisatii -> caracterul alb si invizibil new line (enter)
                }
            }
