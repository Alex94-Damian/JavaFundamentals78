...
/*Write an application that will take a positive number from the user (type int) and calculate the Fibonacci
 ...
 Fibonacci number. In Fibonacci sequence, each number is the sum of the two preceding ones. For example,
...
public class Fibonacci {
    public static void main(String[] args) {
        ...
        System.out.println("Citeste indexul elementului din sirul Fibonacci: ");
        int n = sc.nextInt();

        if(n<0) {
            System.out.println("Input invalid, n>=0");
        }else {
            System.out.println("Al " +n + "-lea numar finoacci: " + getFibonacciByIndex(n));
        }
    }
